...
class Enum {
   ...
   * @param {Object} options.ignoreCase=false - Ignore case in comparisons
   */
  constructor(obj, options = {}) {
    // initialize objects
    this.valuesObject = this._mountValueObject(obj)
    this.descriptionsObject = this._mountDescriptionObject(obj)

    // create a new object with only public functions
    const returnEnum = this._mountEnumObject(obj, options)
